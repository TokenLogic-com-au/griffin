...
import {IsGho} from "src/interfaces/IsGho.sol";
    ...
    IsGho
{
    ...
    bytes32 private constant sGhoStorageLocation = 0x52190d4bcaca04cac5a7c2ae78ea3854d285be3b91819fb1b3ed9862d9a9a400;
     ...
     */
    function initialize(address gho, uint160 initialSupplyCap, address owner) public payable initializer {
